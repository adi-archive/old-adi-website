class AddImageToFeatures < ActiveRecord::Migration
  def self.up
     ...
     def self.down
       remove_column :features, :image_file_name
       remove_column :features, :image_content_type
       remove_column :features, :image_file_size
       remove_column :features, :image_updated_at
     end
